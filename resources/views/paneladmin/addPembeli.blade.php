              ...
              <div class="row justify-content-between">
                ...
                <div class="col-md-8">
                  <br>
                    <div class="form-group">
                      ...
                      @endif
                        <br>
                      <input style="text-transform:uppercase"  type="text" name="id_pembeli" class="form-control" id="id_pembeli" placeholder="Masukkan ID..." value="{{old('id_pembeli')}}">
                    </div>
                    <div class="form-group">
                      ...
                      @endif
                        <br>
                      <input type="text" name="nama_pembeli" class="form-control" id="nama_pembeli" placeholder="Masukkan Nama..." value="{{old('nama_pembeli')}}">
                    </div>
                    <div class="form-group">
                      ...
                      @endif
                        <br>
                      <textarea class="form-control" name="alamat_pembeli" id="alamat_pembeli" rows="17">{{old('alamat_pembeli')}}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    ...
                    @endif
                    <input type="number" name="no_telpon" class="form-control" id="no_telpon" placeholder="Masukkan Nomor..." value="{{old('no_telpon')}}">
                  </div>
                  <div class="form-group">
